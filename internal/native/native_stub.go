...
func SessionCreate(string) (SessionRef, error) {
	return nil, errors.New("fundament: macOS 15+ with cgo is required")
}

func SessionDestroy(SessionRef) {}

func SessionRespond(SessionRef, string, string) (string, error) {
	return "", errors.New("fundament: macOS 15+ with cgo is required")
}
...
func CheckAvailability() (Availability, error) {
	return Availability{}, errors.New("fundament: macOS 15+ with cgo is required")
}
